if [ -f "/opt/repos/fzf/shell/completion.bash" ]; then
  source "/opt/repos/fzf/shell/completion.bash"
else
  if [[ $- =~ i ]]; then
...
if [ -f "/opt/repos/fzf/shell/key-bindings.bash" ]; then
  source "/opt/repos/fzf/shell/key-bindings.bash"
else
  __fzf_select__() {
    local cmd opts

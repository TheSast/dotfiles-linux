(
  ...
  [
    ...
    "os/firefly/sshd/ssh_host_ed25519_key.age"
    "os/firefly/sshd/ssh_host_ed25519_key.pub.age"
    "os/firefly/sshd/ssh_host_rsa_key.age"
    "os/firefly/sshd/ssh_host_rsa_key.pub.age"
    "os/firefly/luks-password.age"
